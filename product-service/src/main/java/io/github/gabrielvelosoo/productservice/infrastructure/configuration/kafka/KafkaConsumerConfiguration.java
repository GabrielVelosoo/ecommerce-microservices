package io.github.gabrielvelosoo.productservice.infrastructure.configuration.kafka;
...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderItemRemovedEvent> orderItemRemovedKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OrderItemRemovedEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(createConsumerFactory(OrderItemRemovedEvent.class));
        return factory;
    }
}
